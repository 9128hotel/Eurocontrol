...
memory = Memory(location='./cache_folder', mmap_mode='r+')
...
for idx, file_path in enumerate(sorted_files):
    ...
    df_merged = pd.merge(df, df_sqlite, on='flight_id', how='left')
...
print("[DONE] Training Complete and Saved")
